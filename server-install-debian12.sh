...
[ -d /home/ark_center ] || useradd -m -U ark_center


# Install ARK Survival Ascended Dedicated
sudo -u ark_center /usr/games/steamcmd +login anonymous +app_update 2430930 validate +quit
...
if [ -e "/home/ark_center/Steam" ]; then
  STEAMDIR="/home/ark_center/Steam"
elif [ -e "/home/ark_center/.local/share/Steam" ]; then
  STEAMDIR="/home/ark_center/.local/share/Steam"
else
...
[ -d "$STEAMDIR/compatibilitytools.d" ] || sudo -u ark_center mkdir -p "$STEAMDIR/compatibilitytools.d"
sudo -u ark_center tar -x -C "$STEAMDIR/compatibilitytools.d/" -f "/opt/game-resources/$PROTON_TGZ"


# Install default prefix into game compatdata path
[ -d "$STEAMDIR/steamapps/compatdata" ] || sudo -u ark_center mkdir -p "$STEAMDIR/steamapps/compatdata"
[ -d "$STEAMDIR/steamapps/compatdata/2430930" ] || \
  sudo -u ark_center cp "$STEAMDIR/compatibilitytools.d/$PROTON_NAME/files/share/default_pfx" "$STEAMDIR/steamapps/compatdata/2430930" -r
...
[ -e "/home/ark_center/island-GameUserSettings.ini" ] || \
  sudo -u ark_center ln -s "$STEAMDIR/steamapps/common/ARK Survival Ascended Dedicated Server/ShooterGame/Saved/Config/WindowsServer/GameUserSettings.ini" /home/ark_center/island-GameUserSettings.ini

[ -e "/home/ark_center/island-ShooterGame.log" ] || \
  sudo -u ark_center ln -s "$STEAMDIR/steamapps/common/ARK Survival Ascended Dedicated Server/ShooterGame/Saved/Logs/ShooterGame.log" /home/ark_center/island-ShooterGame.log
...
echo ""
echo "Configuration is available in /home/ark_center/island-GameUserSettings.ini"
